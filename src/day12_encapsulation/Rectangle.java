...
public class Rectangle {
    ...
    public void setWidth(double width) {
        if (width <= 0){ System.err.println("Width can not be zero or negative"); System.exit(1); }
        this.width = width;
    }
    ...
    public void setLength(double length) {
        if (length <= 0){ System.err.println("Length can not be zero or negative"); System.exit(1); }
        this.length = length;
    }
