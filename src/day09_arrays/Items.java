...
public class Items {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < items.length; i++) { if (items[i].equalsIgnoreCase("gloves")) { indexNumber = i; } }
        System.out.println(indexNumber);

        for (String containInList : items) { if (containInList.contains("iPad")) { contain = true;  System.out.println(contain); } }
